...
export const Help: React.FC = () => {
  ...
  const sections = [
  { id: 'overview', title: 'Overview', icon: '🏠', color: vars.primary[600] },
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: spacing[4], marginBottom: spacing[6] }}>
        <div style={{
          ...
          <div style={{ fontSize: '2.5em', marginBottom: spacing[2] }}>📊</div>
            <h3 style={{ ...typography.textStyles.h4, color: vars.success[600], marginBottom: spacing[2] }}>
            5M+ Contracts
          </h3>
            <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0 }}>
            Comprehensive database of awarded government contracts
          </p>
        </div>
        <div style={{
          backgroundColor: vars.primary[50],
          border: `1px solid ${vars.primary[600]}`,
          borderRadius: spacing[2],
          padding: spacing[4],
          textAlign: 'center'
        }}>
          <div style={{ fontSize: '2.5em', marginBottom: spacing[2] }}>🏢</div>
          <h3 style={{ ...typography.textStyles.h4, color: vars.primary[600], marginBottom: spacing[2] }}>
            23K+ Organizations
          </h3>
          <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '2.5em', marginBottom: spacing[2] }}>👥</div>
          <h3 style={{ ...typography.textStyles.h4, color: vars.warning[600], marginBottom: spacing[2] }}>
            119K+ Contractors
          </h3>
          <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: spacing[4] }}>
        <Card $isDark={isDark} style={{ textAlign: 'center' }}>
          ...
          <h3 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[2] }}>
            Advanced Search
          </h3>
          <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0 }}>
    ...
    <Card $isDark={isDark}>
      <div style={{ display: 'flex', alignItems: 'center', gap: spacing[3], marginBottom: spacing[4] }}>
        ...
        <div>
          ...
          <BodyText $isDark={isDark} style={{ margin: 0, color: vars.text.secondary }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: spacing[4], marginBottom: spacing[6] }}>
        <div style={{
          ...
          <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0, fontSize: typography.fontSize.sm }}>
    ...
    <Card $isDark={isDark}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: spacing[4], marginBottom: spacing[6] }}>
        <div style={{
          ...
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3], display: 'flex', alignItems: 'center', gap: spacing[2] }}>
  ...
  const renderAnalytics = () => (
    <Card $isDark={isDark}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>How to Use Analytics</h4>
      <ol style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
  ...
  const renderTreemap = () => (
    <Card $isDark={isDark}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>How to Use Treemap</h4>
      <ol style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
  ...
  const renderDrillDown = () => (
    <Card $isDark={isDark}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Drill-down Levels</h4>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: spacing[3], marginBottom: spacing[4] }}>
        <div style={{
          ...
          <h5 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[2], fontSize: typography.fontSize.sm }}>Level 1: Entity Analysis</h5>
          <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0, fontSize: typography.fontSize.sm }}>
        ...
        <div style={{
          ...
          <h5 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[2], fontSize: typography.fontSize.sm }}>Level 2: Nested Analysis</h5>
          <p style={{ ...typography.textStyles.body, color: vars.text.secondary, margin: 0, fontSize: typography.fontSize.sm }}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Available Tabs</h4>
      <ul style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1] }}>
  ...
  const renderPresets = () => (
    <Card $isDark={isDark}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Saving Filters</h4>
      <ol style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Loading Filters</h4>
      <ol style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Predefined Filters</h4>
      <ul style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1] }}>
  ...
  const renderDataset = () => (
    <Card $isDark={isDark}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Dataset Features</h4>
      <ul style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1] }}>
      ...
      <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>How to Use</h4>
      <ol style={{ paddingLeft: spacing[4], marginBottom: spacing[4] }}>
        <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
    ...
    <Card $isDark={isDark}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: spacing[4] }}>
        <div style={{
          ...
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>DPWH District Analysis</h4>
          <ol style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1], fontSize: typography.fontSize.sm }}>
        ...
        <div style={{
          ...
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Flood Control Projects</h4>
          <ol style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1], fontSize: typography.fontSize.sm }}>
        ...
        <div style={{
          ...
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Contractor Performance</h4>
          <ol style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1], fontSize: typography.fontSize.sm }}>
        ...
        <div style={{
          ...
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Keyword Search</h4>
          <ol style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[1], fontSize: typography.fontSize.sm }}>
  ...
  const renderTips = () => (
    <Card $isDark={isDark}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: spacing[4] }}>
        <div>
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Search Tips</h4>
        ...
        <div>
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Analytics Tips</h4>
          <ul style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
        ...
        <div>
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>General Tips</h4>
          <ul style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
  ...
  const renderTroubleshooting = () => (
    <Card $isDark={isDark}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: spacing[4] }}>
        <div>
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Common Issues</h4>
          <ul style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
        ...
        <div>
          <h4 style={{ ...typography.textStyles.h4, color: vars.text.primary, marginBottom: spacing[3] }}>Performance Tips</h4>
          <ul style={{ paddingLeft: spacing[4] }}>
            <li style={{ ...typography.textStyles.body, color: vars.text.primary, marginBottom: spacing[2] }}>
